...
class Model {
	...
	private void checkSymbol(Object symbol) { if(symbol != this.secret_symbol) throw new NullPointerException("Counterfeit symbol!"); } //delete this method calls to cheat! LOLZ
	...
	void setFlagEnergyBlue(Object symbol, float val) { checkSymbol(symbol); energy_blue = val; } //cheat here
	void setFlagEnergyRed(Object symbol, float val) { checkSymbol(symbol); energy_red = val; } //cheat here
