...
public class Matrix
{
	...
	// Data
	private ArrayList<double[]> m_data = new ArrayList<double[]>(); //matrix elements; row: individual chromosomes
	...
	public double columnMean(int col) //call this on fights per gen column
	{
		double sum = 0.0;
		int count = 0;
